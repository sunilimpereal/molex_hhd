...
import 'package:molex_mobile/model_api/materialCoordinator/material_cord_schedule_model.dart';
import 'package:molex_mobile/models/material_schedule.dart';
import 'drop.dart';
                      ...
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) => KittingDrop(
                                    userId: widget.userId , machineId: '',
                                  )));
                    },
                  ),
                )
...
class _MaterialcordScheduleState extends State<MaterialcordSchedule> {
  ...
  List<MaterialCodinatorScheduler> searchfilter(
      List<MaterialCodinatorScheduler> scheduleList) {
    switch (widget.searchType) {
      case "Order ID":
        return scheduleList
            .where((element) =>
                element.orderId.toString().startsWith(widget.query))
            .toList();
        break;
      case "FG":
        return scheduleList
            .where(
                (element) => element.fgNo.toString().startsWith(widget.query))
            .toList();
        break;
      case "Schedule ID":
        return scheduleList
            .where((element) =>
                element.scheduleId.toString().startsWith(widget.query))
            .toList();
        break;
      case "Location":
        return scheduleList
            .where((element) =>
                element.location.toString().startsWith(widget.query))
            .toList();
        break;
      default:
        return scheduleList;
        ...
        children: [
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        bottom: BorderSide(
                          //                   <--- left side
                          color:
                              type == "Yet To Kit" ? Colors.red : Colors.white,
                          width: 3.0,
                        ),
                      )),
                      child: Center(
                        ...
                        style: GoogleFonts.openSans(
                          ...
                          fontSize: 12,
                          color:
                              type == "Yet To Kit" ? Colors.red : Colors.black,
                          fontWeight: FontWeight.w600,
                        )),
                      )),
                    ),
          ...
          SingleChildScrollView(
            child: Container(
              ...
              child: FutureBuilder<List<MaterialCodinatorScheduler>>(
                future: apiService.getMaterialCordScheduelarData(),
                builder: (context, snapshot) {
                  ...
                  if (snapshot.hasData) {
                    List<MaterialCodinatorScheduler> materialCordList =
                        searchfilter(snapshot.data!);

                    materialCordList = type == "Staging"
                        ? materialCordList
                            .where((element) =>
                                locations.contains(element.location))
                            .toList()
                        : materialCordList;
                    materialCordList = type == "Staging"
                        ? materialCordList
                    ...
                    return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return buildDataRow(
                              materialSchedule: materialCordList[index]);
                        });
                  } else {
                    return Container();
                  }
            ...
            children: [
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      field(
                          title: "Order ID",
                          value: "${materialSchedule.orderId}"),
                      field(title: "FG Number", value: materialSchedule.fgNo),
                      field(
                          title: "Schedule ID",
                          value: materialSchedule.scheduleId),
                    ],
                  ),
                ),
              ),
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    field(
                        title: "Location ID", value: materialSchedule.location),
                    field(title: "RouteId", value: materialSchedule.routeId),
                    field(
                        title: "Total Bundles",
                        value: materialSchedule.totalBundle),
                  ],
                ),
              ),
              SizedBox(width: 0),
              ...
              Column(
                ...
                children: [
                  ...
                  Container(
                      ...
                      decoration: BoxDecoration(
                          color: materialSchedule.status == 'Dropped'
