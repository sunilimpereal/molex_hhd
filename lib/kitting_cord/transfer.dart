...
import 'package:molex_mobile/widgets/loading_button.dart';
                                ...
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    onPressed: () {
                                      ...
                                      apiService
                                          .getBundlesinBinStatus(postgetBundleMaster)
                                          .then((value) {
                                        List<BundlesRetrieved> addBundles = value!;
                                        addBundles = addBundles
                                            .where((element) =>
                                                element.binId.toString() == binId.toString())
                                            .toList();
                                        setState(() {
                                          if (!bundleList
                                              .map((e) => e.binId)
                                              .toList()
                                              .contains(addBundles[0].binId)) {
