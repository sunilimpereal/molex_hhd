            ...
            builder: (context, snapshot) {
              if (snapshot.hasData) {
                ...
                materialCordList = type == "Yet To Be Picked"
                    ? materialCordList
                        .where(
                            (element) => element.status == "Yet To Be Picked")
                        .toList()
                    : materialCordList
              ...
              Column(
                ...
                children: [
                  ...
                  Container(
                      ...
                      decoration: BoxDecoration(
                          color: materialSchedule.status == 'Yet To Be Picked'
                              ? Colors.grey.shade100
                              : Colors.red.shade100,
                          borderRadius: BorderRadius.all(Radius.circular(30))),
                      child: Center(
                        child: Text(
                          materialSchedule.status == 'Yet To Be Picked'
                              ? "Yet To Pick"
                              : "picked",
                          style: TextStyle(
                              fontSize: 12,
