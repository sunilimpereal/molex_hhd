...
import 'package:molex_mobile/KittingIssance/kittingissuancehome.dart';
            ...
            style: ButtonStyle(
              shape: MaterialStateProperty.all<RoundedRectangleBorder>(
                RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(6.0), side: BorderSide(color: Colors.red)),
              ),
              ...
              children: [
                ...
                Column(
                  children: [
                    field(
                        title: "Order ID",
                        data: widget.kittingDetail.kittingIssuance.orderId,
                        width: 0.21),
                    field(
                        title: "Fg No.",
                        data: widget.kittingDetail.kittingIssuance.fgPartNumber.toString(),
                        width: 0.21),
                  ],
                ),
                Column(
                  ...
                  children: [
                    field(
                        title: "color",
                        data: widget.kittingDetail.kittingIssuance.wireCuttingColor.toString(),
                        width: 0.1),
                    field(
                        title: "Bundle Count /Qty",
                        data:
                            "${widget.kittingDetail.bundleList.length} /${getTotalQuantityinKitting(kittingDetail: widget.kittingDetail)}",
                        width: 0.3),
                  ],
                ),
                Column(
                  children: [
                    field(
                        title: "Location",
                        data: widget.kittingDetail.kittingIssuance.binLocation,
                        width: 0.2),
                    field(
                        title: "Bin ID",
                        data: widget.kittingDetail.kittingIssuance.binId,
                        width: 0.2),
                  ],
                ),
                SizedBox(
