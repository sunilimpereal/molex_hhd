...
import 'package:molex_mobile/model_api/kitting/bundle_detail_sts_model.dart';
import 'package:molex_mobile/model_api/kitting/kittingall_model.dart';
  ...
  static List<KittingDetail> convertToKittingDirect(List<BundlesRetrieved> bundles, String fgNum) {
    ...
    while (bundlesLopp.length > 0) {
      ...
      if (selectedbundles.length > 0) {
        KittingDetail kittingData =
            convertBundleListToKitting(bundle: bundle, selectedbundles: selectedbundles);
    ...
    while (kittingLoop.length > 0) {
      ...
      for (KittingDetail kittingDetail in kittingLoop) {
        if (selectedKitting.kittingIssuance.binId == kittingDetail.kittingIssuance.binId &&
            selectedKitting.kittingIssuance.binLocation ==
                kittingDetail.kittingIssuance.binLocation) {
          if (selectedKitting.kittingIssuance.wireCuttingColor ==
              kittingDetail.kittingIssuance.wireCuttingColor) {
